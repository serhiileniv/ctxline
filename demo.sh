...
for u in 8000 40238 210000 460000 604000 780000 862000 961000; do
  printf '   %s%3d%%%s   ' "$D" $((u * 100 / 1000000)) "$R"; fill "Opus 5.5" 1000000 "$u"
done
...
printf '   %sgreen      <60%%%s  ' "$D" "$R"; fill "Opus 5.5" 200000 40238
printf '   %syellow     >60%%%s  ' "$D" "$R"; fill "Opus 5.5" 200000 130000
printf '   %sbold rose  >85%%%s  ' "$D" "$R"; fill "Opus 5.5" 200000 180000
...
pay '{"model":{"display_name":"Opus 5.5"},"context_window":{"context_window_size":200000}}'
...
pay '{"model":{"display_name":"Opus 5.5"},"context_window":{"current_usage":{"input_tokens":950000}}}'
...
printf '{"model":{"display_name":"Opus 5.5"},"context_window":{"context_window_size":200000,"current_usage":{"input_tokens":180000}}}' \
  | NO_COLOR=1 "$B"
